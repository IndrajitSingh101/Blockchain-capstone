...
contract Ownable {
    ...
    modifier onlyOwner(){
        require(isOwner(),"caller must be contract owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner!=address(0),"owner must be a valid address");
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(owner!=address(0),"token owner address should be" );
        return owner;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to!=owner,"address cannot be the owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender==owner||isApprovedForAll(owner, msg.sender),"message sender needs to be owner of the contract or approve for all needs to be approved");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from==ownerOf(tokenId),"source address does not own the token");
...
contract CustomERC721Token is ERC721Metadata("Abode Token","ABT","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
